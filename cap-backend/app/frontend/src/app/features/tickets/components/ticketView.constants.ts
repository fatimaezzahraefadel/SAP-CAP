...
export const TICKET_STATUS_TRANSITIONS: Record<TicketStatus, TicketStatus[]> = {
  ...
  NEW: ['IN_PROGRESS', 'IN_TEST', 'BLOCKED', 'DONE', 'REJECTED'],
  IN_PROGRESS: ['NEW', 'IN_TEST', 'BLOCKED', 'DONE', 'REJECTED'],
  IN_TEST: ['NEW', 'IN_PROGRESS', 'BLOCKED', 'DONE', 'REJECTED'],
  BLOCKED: ['NEW', 'IN_PROGRESS', 'IN_TEST', 'DONE', 'REJECTED'],
  DONE: ['NEW', 'IN_PROGRESS', 'IN_TEST', 'BLOCKED', 'REJECTED'],
