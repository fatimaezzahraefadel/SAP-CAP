  ...
  MANAGER: makeRoleGroup({
    ...
    routes: [
      ...
      },
      {
        ...
        nav: { label: 'Demandes de congés', iconKey: 'calendar-days' },
      },
      {
        id: 'manager-calendar',
        path: 'calendar',
        lazy: lazyNamed(() => import('../pages/gestion/GestionManagerFiori.page'), 'GestionManagerFiori'),
        nav: { label: 'Calendrier annuel', iconKey: 'calendar-days' },
      },
      {
        id: 'manager-certificates',
        path: 'certificates',
        lazy: lazyNamed(() => import('../pages/gestion/GestionManagerFiori.page'), 'GestionManagerFiori'),
        nav: { label: 'Certificats équipe', iconKey: 'award' },
      },
      {
  ...
  CONSULTANT_TECHNIQUE: makeRoleGroup({
    ...
    routes: [
      ...
      },
      {
        ...
        nav: { label: 'Mes congés et certificats', iconKey: 'calendar-days' },
      },
    ],
  }),
