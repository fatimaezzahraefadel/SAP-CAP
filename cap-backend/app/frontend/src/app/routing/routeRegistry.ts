    ...
    routes: [
      {
        ...
        path: 'dashboard',
        redirectTo: '/manager/leave',
      },
      {
        id: 'manager-leave',
        path: 'leave',
        lazy: lazyNamed(() => import('../pages/gestion/GestionManagerFiori.page'), 'GestionManagerFiori'),
        nav: { label: 'Congés', iconKey: 'calendar-days' },
      },
      {
        id: 'manager-calendar',
        path: 'calendar',
        lazy: lazyNamed(() => import('../pages/gestion/GestionManagerFiori.page'), 'GestionManagerFiori'),
        nav: { label: 'Calendrier équipe', iconKey: 'calendar-days' },
      },
      {
        id: 'manager-certificates',
        path: 'certificates',
        lazy: lazyNamed(() => import('../pages/gestion/GestionManagerFiori.page'), 'GestionManagerFiori'),
        nav: { label: 'Certificats', iconKey: 'award' },
      },
      {
        id: 'manager-consultants',
        path: 'consultants',
        lazy: lazyNamed(() => import('../pages/gestion/GestionManagerFiori.page'), 'GestionManagerFiori'),
        nav: { label: 'Consultants', iconKey: 'users' },
      },
      {
        id: 'manager-admin',
        path: 'admin',
        lazy: lazyNamed(() => import('../pages/manager/ManagerAdmin.page'), 'ManagerAdmin'),
        nav: { label: 'Administration', iconKey: 'shield' },
      },
    ],
  }),
